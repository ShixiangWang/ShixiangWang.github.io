...
我之前也很困惑，所以看过很多介绍。主要是我们混淆了修改别人的代码和使用别人代码，开源协议限制的是对别人代码的修改，不限制后者。

一般我们做数据分析，喜欢拷贝和利用已有的代码，如果在拷贝的基础上发生修改，就是“改写”行为。假设这个代码不遵守相关的协议，那么就违规啦。但是，如果你是看着别人的思路或代码自己完全重新写的，
